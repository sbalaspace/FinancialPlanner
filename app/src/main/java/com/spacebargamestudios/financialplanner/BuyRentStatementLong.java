...
public class BuyRentStatementLong extends AppCompatActivity {
    ...
    public void loadData(int freq){
        ...
        FinTable[] data = calc.BuyRentStatement();
        ...
        for(int ii = -1; ii < rows; ii++){
            ...
            if (ii == -1){
                ...
                tv.setText(String.valueOf(row.year +"y " + (row.month) +"m "));
                if ((ii+1)%12 == 0){
            ...
            if (ii == -1){
                ...
                tv1.setText(decimalFormat.format(row.sip*freq));
            ...
            if (ii == -1){
                ...
                tv2.setText(decimalFormat.format(row.expense*freq));
            ...
            if (ii == -1){
                ...
                tv3.setText(decimalFormat.format(row.principal*freq));
            ...
            if (ii == -1){
                ...
                tv4.setText("  Renter Corpus  ");
                tv4.setBackgroundColor(Color.parseColor("#f0f0f0"));
            } else if ((ii+1)%freq == 0) {
                tv4.setText(decimalFormat.format(row.totalInvested));
            ...
            if (ii == -1){
                ...
                tv5.setText("  Buyer Corpus  ");
                tv5.setBackgroundColor(Color.parseColor("#f0f0f0"));
            } else if ((ii+1)%freq == 0) {
                tv5.setText(decimalFormat.format(row.totalInterest));
                tv5.setTextColor(Color.parseColor("#8b008b"));
